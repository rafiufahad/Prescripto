...
const MyProfile = () => {
  ...
  const [ userData, setUserData ] = useState({
    ...
    emailL: 'richardjameswap@gmail.com',
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='text-blue-500'>{userData.emailL}</p>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          { 
          isEdit 
            ? <select className='max-w-28 bg-gray-100' onChange={(e) => setUserData(prev => ({...prev, gender:e.target.value}))}>
